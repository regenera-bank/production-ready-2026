...
// [FILE] apps/services/account-service/src/health/health.controller.ts
...
export class HealthController {
  ...
  @HealthCheck()
  check() {
    // Don Paulo: Verificação vital. Se a DB morrer, o sistema morre.
    // Adicionar outras verificações conforme a necessidade do serviço.
    // Ex: Redis, RabbitMQ, outros microsserviços downstream.
    return this.health.check([
      () => this.db.pingDb(), // Verifica a conexão com o banco de dados.
    ]);
  }
}
