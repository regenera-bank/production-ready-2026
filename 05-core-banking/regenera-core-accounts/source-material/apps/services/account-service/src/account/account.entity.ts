...
// [FILE] apps/services/account-service/src/account/account.entity.ts
...
// This transformer ensures our Money value object is stored as a simple integer (cents) in the database.
...
export class Account {
  ...
  @Column({
    type: 'bigint', // Use bigint for storing large integer values for money.
