...
- Name: pix-flow.spec.ts >> BFF banking — pix flow >> envia Pix interno com crédito homolog de R$1
- Location: tests/pix-flow.spec.ts:10:3

# Error details

```
Error: kyc/document failed: 400 {"message":"Envie o documento somente após a etapa cadastral","error":"Bad Request","statusCode":400}
```
