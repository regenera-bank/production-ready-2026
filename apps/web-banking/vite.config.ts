...
export default defineConfig({
  ...
  preview: {
    ...
    headers: {
      ...
      'Permissions-Policy':
        'camera=(self "https://verify.didit.me"), microphone=(self "https://verify.didit.me"), fullscreen=(self "https://verify.didit.me"), geolocation=()',
  ...
  server: {
    ...
    proxy: {
      '/api': {
        target: process.env.VITE_BFF_PROXY ?? 'http://localhost:3200',
        changeOrigin: true,
