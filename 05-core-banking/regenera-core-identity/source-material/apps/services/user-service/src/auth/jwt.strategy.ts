...
// [FILE] apps/services/user-service/src/auth/jwt.strategy.ts
...
export class JwtStrategy extends PassportStrategy(Strategy) {
  constructor() {
    super({
      ...
      // ATENÇÃO: Secret hardcoded para POC/dev. EM PROD, use um Vault/HSM e injete via config/env.
   ...
   * This ensures zero-trust between services.
   */
