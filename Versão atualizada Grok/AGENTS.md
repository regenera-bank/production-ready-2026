...
- `3-desing-final-escolhido-geral-index.html` — protótipo HTML de 4.251 linhas
- Fonte: Manrope
...
- `money.value-object.ts` — Money com BigInt, TypeORM transformer, proibição de float real
- `money_value-object.ts` — mesma coisa, extensão alternativa
...
- `STYLE_pt-BR.md` — contrato de tom: comentário explica porquê e risco, nunca o quê

**Mapa mestre:**
- `MAPA_MESTRE_DESENVOLVIMENTO_CANAIS_REGENERA_BANK.md` — 20 seções, 1.225 linhas, plano de 90 dias + ondas A–E
...
REGRA 6 — COMENTÁRIO NO TOM DA CASA
  Segue STYLE_pt-BR.md: porquê e risco, nunca o quê.
