...
PR-04a  V001 SQL (schema + 4 triggers)           ⏳ PRÓXIMO
PR-04b  V002 SQL (views operacionais)            ⬜
PR-05   audit-chain                              ⬜
PR-06   outbox                                   ⬜
PR-07   idempotency (hash + UNKNOWN)             ⬜
PR-08   holds                                    ⬜
PR-09   ledger (12 invariantes — GATE)           ⬜
PR-10   payments (15 invariantes — após PR-09)   ⬜
PR-11   pix (E2E BACEN, HMAC)                    ⬜
PR-12   reconciliation                           ⬜
PR-13   core-bank.module.ts                      ⬜
PR-14   47 testes integração (GATE)              ⬜
PR-15   load test 50k/dia + canário              ⬜
```

**Progresso:** 5 / 16 PRs (31% do core)
...
| **Total gate** | **47** | **PR-14** | **0% integração** |
...
```
apps/web-banking/       React, Manrope, #22d3ee / #020617
bff/web-bff/            NestJS — compõe, não acessa ledger
domains/identity/       login, MFA, device trust
domains/accounts/       via Core Banking
domains/statements/     extrato paginado
contracts/openapi/      Account, Balance, Statement, Error
```
